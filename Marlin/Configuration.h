...
#define STRING_CONFIG_H_AUTHOR "(Taomyn, for SKR-mini-E3-V3.0)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 28.7461
    #define DEFAULT_Ki 2.7747
    #define DEFAULT_Kd 74.4523
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 45.0471
  #define DEFAULT_bedKi 8.8658
  #define DEFAULT_bedKd 152.5894
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.20, 80.50, 400.20, 98.6 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -46, 5, -1.3110 }
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_SENSOR_DEBUG    // Enable debugging
